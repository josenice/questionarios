...
insert into campotextual (id, descricao, avaliacao_id) values (1, 'Alunos com destaques positivos para o item', 1);
insert into campotextual (id, descricao, avaliacao_id) values (2, 'Alunos com problema no item', 1);

insert into itemavaliacao (id, texto, usarfrequencia, questionario_id) values (2, 'A Turma comparece às aulas diariamente?', true, 1);
insert into campotextual (id, descricao, avaliacao_id) values (3, 'Alunos com destaque positivo para o item', 2);
insert into campotextual (id, descricao, avaliacao_id) values (4, 'Alunos com problema no item', 2);

insert into itemavaliacao (id, texto, usarfrequencia, questionario_id) values (3, 'A Turma possui um bom rendimento?', true, 1);
insert into campotextual (id, descricao, avaliacao_id) values (5, 'Alunos com destaque possitivo para o item', 3);
insert into campotextual (id, descricao, avaliacao_id) values (6, 'Alunos com problema no item', 3);
...
insert into campotextual (id, descricao, avaliacao_id) values (7, 'Alunos com destaque possitivo para o item', 4);
insert into campotextual (id, descricao, avaliacao_id) values (8, 'Alunos com problema no item', 4);
...
insert into campotextual (id, descricao, avaliacao_id) values (9, 'Alunos com destaque possitivo para o item', 5);
insert into campotextual (id, descricao, avaliacao_id) values (10, 'Alunos com problema no item', 5);
...
insert into campotextual (id, descricao, avaliacao_id) values (11, 'Alunos com destaque possitivo para o item', 6);
insert into campotextual (id, descricao, avaliacao_id) values (12, 'Alunos com problema no item', 6);
...
insert into campotextual (id, descricao, avaliacao_id) values (13, NULL, 7);

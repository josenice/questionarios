...
insert into bimestreletivo (id, bimestre, ano, modeloautoavaliacao_id, modeloavaliacaodeturma_id) values (1, 1, 2014, 1, 1);
insert into turmaSeriada (id, codigoSistemaAcademico) values (1, '23');
insert into diario (id, codigoSistemaAcademico, turma_id, anoLetivo) values (1, '32', 1, 2014);

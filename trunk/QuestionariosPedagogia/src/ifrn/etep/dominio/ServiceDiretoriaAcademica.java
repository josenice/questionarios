...
public class ServiceDiretoriaAcademica implements Serializable{
	...
	public List<DiretoriaAcademica> getTodas(){
		return repositorio.getAll();
	}
	
	public void cadastrarDiretoria(DiretoriaAcademica diretoria){
		this.repositorio.insert(diretoria);
	}
	
	public void atualizarDiretoria(DiretoriaAcademica diretoria){
		this.repositorio.update(diretoria);
	}
